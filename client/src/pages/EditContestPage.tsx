        ...
        {isNewContest ? (
          <section className="edit-contest-page-card" aria-labelledby="edit-section-deferred">
            ...
            <p className="edit-contest-schedule-intro">
              ...
              для этого нужен <code>id</code> черновика. Нажмите «Создать черновик» внизу страницы: после сохранения
            ...
            <label className="edit-contest-voting-row">
              ...
              <span className="edit-contest-voting-text">
                ...
                <p className="edit-contest-voting-hint">
                  {isNewContest
                    ? 'Критерии и состав жюри появятся после создания черновика (кнопка внизу страницы), затем — в этом разделе и в блоке номинаций выше.'
          ...
          {juryVoting && isNewContest ? (
            <div className="edit-contest-voting-deferred" role="status" aria-live="polite">
              ...
              <p className="edit-contest-voting-deferred-text">
                ...
                Нажмите «Создать черновик» внизу: страница откроется в режиме редактирования, и здесь появятся панели
                настройки жюри (и критерии — также в блоке номинаций выше).
              </p>
            </div>
          ) : null}
