...
export const BRAND_TAGLINE =
  'Платформа фотоконкурсов. Участвуйте в конкурсах, голосуйте за работы.';

/** Длинное описание для meta description (статический index.html и поисковики). */
export const BRAND_META_DESCRIPTION =
  'ShotContest — платформа фотоконкурсов. Участвуйте в конкурсах, голосуйте за работы участников.';
